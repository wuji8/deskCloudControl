        ...
        $(datalist).each(function (i, e) {
            if (i > 0) {
                checkboxhtml += '<div class="checkbox">'+
                        '<label>'+
                            '<input name="form-field-checkbox" checked val="' + e.columnName + '" data-type="' + e.dataType + '" data-index="' + i + '" type="checkbox" class="ace checkboxTableOnly">' +
                            '<span class="lbl" style="margin-left:10px;"> ' + e.columnName + '</span>' +
                        '</label>'+
                    '</div>';

                thhtml += '<th data-type="' + e.dataType + '">' + e.columnName + '</th>';
                //toolhtml += '<td>'+
                //                '<div class="row">'+
