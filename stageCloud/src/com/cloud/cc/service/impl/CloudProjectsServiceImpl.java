...
public class CloudProjectsServiceImpl implements CloudProjectsService {
	...
	@Override
	public CloudProjects selectById(Integer cloudId) {
		// TODO Auto-generated method stub
		return cloudProjectsMapper.selectByPrimaryKey(cloudId);
	}

	@Override
	public List<CloudProjects> selectAllProjects() {
		// TODO Auto-generated method stub
		return cloudProjectsMapper.selectAllProject();
	}
